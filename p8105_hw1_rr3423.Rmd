...
The mean of the flipper lengths is `r round(mean_flipper_length, digits = 2)` mm. The standard deviation of flipper lengths is `r round(sd_flipper_length, digits = 2)` mm. 

The mean of the body weights is `r round(mean_body_mass, digits = 2)` mm. The standard deviation of body weights is `r round(sd_body_mass, digits = 2)` mm.
