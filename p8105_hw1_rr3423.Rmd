...
The mean of the bill lengths is `r round(mean_bill_length, digits = 2)`. The standard deviation of bill lengths is `r round(sd_bill_length, digits = 2)`. 

The mean of the bill depths is `r round(mean_bill_depth, digits = 2)`. The standard deviation of bill depths is `r round(sd_bill_depth, digits = 2)`. 

The mean of the flipper lengths is `r round(mean_flipper_length, digits = 2)`. The standard deviation of flipper lengths is `r round(sd_flipper_length, digits = 2)`. 

The mean of the body weights is `r round(mean_body_mass, digits = 2)`. The standard deviation of body weights is `r round(sd_body_mass, digits = 2)`.
